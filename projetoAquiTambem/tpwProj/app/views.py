        ...
        if form.is_valid():
            ...
            if results:
                ...
                if request.method == 'GET':
                    ...
                    form = CategoryFilter()
            return render(request, 'Items/searchResults.html', {'items': results, 'query': query, 'categories': Category.objects.all(),'form': form, 'itemsFilters': items})
